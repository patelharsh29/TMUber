...
public class TMUberRide extends TMUberService
{
  ...
  public TMUberRide(String from, String to, User user, int distance, double cost)
  {
    ...
    super(from, to, user, distance, cost, TYPENAME);  // supering paramaters that have not been initialized in this class
    this.numPassengers = 0;         // setting number of passengers to 0 beacuse it is an integer variable
    this.requestedXL = false;     // setting requestedXL to false beacuse its a boolean varaible
  }
