...
public class User 
{
  ...
  {
    if (other == null || !(other instanceof User)) {return false;}      // if there is no object provided of the other is not an instance of User then return false
    User otherUser = (User) other;    // else initialize it to the User class
    return ((this.name.equals(otherUser.getName())) && (this.address.equals(otherUser.getAddress())));    // returns true if the name and address are same as current compiling name and address
  }
}
